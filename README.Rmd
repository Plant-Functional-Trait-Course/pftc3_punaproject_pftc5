...
```{r TraitChecks, echo=FALSE, eval=TRUE, fig.cap= "Biplots of some of the trait measurements and traits from the four sites along the 1000 altitudinal gradient in Mt Gongga, Sichuan, China."}
```
...
```{r DiversityPlot, echo=FALSE, eval=TRUE, fig.cap="Figure 3 add fig legend."}
```
